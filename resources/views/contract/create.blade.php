            ...
            <div class="form-group">
              ...
              <select class="form-control" name="award_criteria">
                <option>-- Select Criteria -- </option>
                 ...
                 <option value="bestProposal">Best proposal</option>
                 <option value="bestValueToGovernment">Best value to government</option>
                 <option value="singleBidOnly">Single bid only</option>
              </select>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Enter Project Rationale" type="date" name="award_date">
            </div>
          </div>
