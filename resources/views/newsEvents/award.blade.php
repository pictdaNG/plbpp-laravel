...
@section('title')
  News | PLATEAU STATE BEREAU OF PUPLIC PROCUREMENT RECEIVES AWARD FOR OUTSTANDING PERFORMANCE
@endsection
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
                    ...
                    <div class="uk-flex uk-flex-middle">
                        <div class="uk-card-body">
                            <h3>PLATEAU STATE BEREAU OF PUPLIC PROCUREMENT RECEIVES AWARD FOR OUTSTANDING PERFORMANCE</h3>
