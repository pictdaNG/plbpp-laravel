        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Enter Certified Payment Date" type="text" name="payment_date" value="{{ $ocds->st_payment_date }}">
            </div>              
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Enter Project Title" type="date" name="st_entry_date" value="{{ $ocds->st_entry_date }}">
            </div>              
          </div>
        </div>
