      ...
      <div class="dContainer">
        <div class="img-hover active-1">
          ...
          <div class="img-2 uk-inline-clip uk-transition-toggle" tabIndex="0">
            ...
            <div class="overlay uk-transition-slide-bottom uk-position-bottom uk-overlay uk-overlay-primary">
              <p class="uk-h4 uk-margin-remove">L-DFS,R-DA,CENTRE-DG</p>
              <span class="uk-text-small">Tuesday, Mar 26, 2019 </span>
            </div>
          </div>
        ...
        <div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="min-height: 60; max-height: 60; autoplay: true">
          <div class="news">Latest News</div>
            <ul class="uk-slideshow-items">
              ...
              <li>
                <a href="#" class="p">Breaking news, A Javascript bug killed a browser because a developer told it to console the bug infinitely.</a>
              </li>
            </ul>
                ...
                <div class="card">
                    <div class="uk-card uk-card-default">
                        ...
                        <div class="uk-card-footer">
                            ...
                            <span class="uk-text-danger"><svg xmlns="http://www.w3.org/2000/svg"
