  ...
  public function findAll() {
    ...
    return $tenders;
      ...
      foreach($tenders as $tender) {
        ...
        // $bidOpening = Carbon::createFromFormat('Y-m-d', $tender->bid_submission_open_date);
        // $bidClosing = Carbon::createFromFormat('Y-m-d', $tender->bid_submission_close_date);

        $tenderPeriodObj->startDate = $tender->bid_submission_open_date;  //$bidOpening->toIso8601ZuluString();
        $tenderPeriodObj->endDate =  $tender->bid_submission_close_date;//$bidClosing->toIso8601ZuluString();
