        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Enter Procurement Method" type="text" name="procurement_method_used">
            </div>              
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Enter Project Funding" type="number" name="project_funding">
            </div>              
          </div>
          <div class="col-md-3">
            <div class="form-group">
